...
* The optimal number of clusters was determined using both the Elbow method and the Silhouette score. The Elbow method was used to evaluate the within-cluster sum of squared errors (WCSS) and identify the point where increasing the number of clusters resulted in only a small improvement in reducing variation within clusters. The Silhouette score was also used to evaluate the quality of the clustering by measuring the separation and similarity between clusters. Based on these evaluation methods, K = 2 was selected as the optimal number of clusters. This choice provided a good balance between reducing within-cluster variation and maintaining meaningful separation between groups. The Silhouette score for K = 2 was 0.118, which was the highest value among the tested cluster configurations, indicating that this solution produced the best-defined clusters within the dataset. Therefore, two clusters were considered the most suitable representation of the underlying patterns in the data without introducing unnecessary complexity.
...
**Practical Interpretation of Cluster Results**
The clustering results identify two distinct patient groups: high-lifestyle-risk males who will benefit most from targeted smoking cessation programs and close cardiac monitoring due to their lower ejection fractions, and high-metabolic-risk females who require integrated diabetes, blood pressure, and anemia management to protect their preserved heart function before structural damage can set in.
